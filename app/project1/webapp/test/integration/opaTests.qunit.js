...
sap.ui.require(
  [
    ...
    "sap/ui/qunit/qunit-junit",
    "sap/ui/qunit/qunit-coverage",
    "project1/test/integration/BooksListJourney.gen",
    "project1/test/integration/BooksObjectPageJourney.gen",
    "project1/test/integration/ChaptersObjectPageJourney.gen",
], function (QUnit) {
    "use strict";
    QUnit.start();
});
