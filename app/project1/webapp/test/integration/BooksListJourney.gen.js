...
sap.ui.define([
    ...
    function journey() {
        ...
        opaTest("Check filter bar", function (Given, When, Then) {
            Then.onTheBooksListGenerated.onFilterBar().iCheckFilterField({ property: "Genre" });
        });
        ...
        opaTest("Check table columns and actions", function (Given, When, Then) {
            Then.onTheBooksListGenerated.onTable(defaultTableId).iCheckColumns(undefined, {"Title":{"header":"Title"},"Genre":{"header":"Genre"},"PublishedAt":{"header":"PublishedAt"},"Pages":{"header":"Pages"},"price":{"header":"Price"}});
        });
